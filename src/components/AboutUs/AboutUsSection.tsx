        ...
        <div className='innerContainer flex gap-[80px] flex-wrap'>
          <div className='flex flex-col basis-96 flex-1'>
            <SectionTitle
              image={ServicesIcon}
              title='ABOUT US'
              heading={{ title: 'Your Financial Health Begins With Expert Billing' }}
            />
          ...
          <div className='flex flex-col basis-96 flex-1'>
            ...
            <div className='mt-[56px] flex-1 border-themeTertiary grid grid-cols-2 overflow-hidden border-2 rounded-[30px]'>
              <div className='border-r-2 border-b-2 border-themeTertiary flex__center flex-col p-10'>
                ...
                <p className='font-urbanist font_16_400 text-[#788094] text-center whitespace-nowrap'>Satisfied Clients</p>
              </div>
              <div className='border-b-2 border-themeTertiary flex__center flex-col p-10'>
                ...
                <p className='font-urbanist font_16_400 text-[#788094] text-center whitespace-nowrap'>RCM Specialists</p>
              </div>
              <div className='border-r-2 border-themeTertiary flex__center flex-col p-10'>
                ...
                <p className='font-urbanist font_16_400 text-[#788094] text-center whitespace-nowrap'>Claims Processed Successfully</p>
              </div>
              <div className='flex__center flex-col p-10'>
                ...
                <p className='font-urbanist font_16_400 text-[#788094] text-center whitespace-nowrap'>Industry Awards Won</p>
              </div>
            </div>
          </div>
        </div>
