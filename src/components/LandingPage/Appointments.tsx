...
import { CustomSelect, InputField, SectionWrapper, type SelectOption } from '@/components/common'
import Image from 'next/image'
import { appointment_docs1, appointment_docs2, appointment_dotted_bg } from '@/assets'
import { Button, Input } from '@/components/ui'
import { FaAngleDown, FaRegCalendar, FaRegClock, FaRegEnvelope, FaRegUser } from 'react-icons/fa6'
    ...
    >
      <div className='flex justify-center xl:justify-end relative z-10 py-10 px-0 md:px-10 xl:px-0 w-full xl:w-[430px]'>
        ...
        <div className='bg-themeSecondary rounded-[20px] w-full max-w-none xl:max-w-[370px] px-4 md:px-[30px] py-10 text-white'>
          ...
          We are available to support your practice&apos;s billing needs during the following hours:
          </p>
          <ul className=''>
            {timings.map(timing => {
              return (
      ...
      <div className='flex-1 rounded-[20px] flex-col xl:flex-row shadow-appointmentForm p-5 md:p-10 flex gap-10'>
        ...
        <div className='flex-1'>
          <h4 className='font-urbanist font_30_700 text-center mb-2 '>Get In Touch</h4>
          <p className='font_18_400 text-[#788094] text-center'>Need help with your medical billing?</p>
          <p className='font_18_400 text-[#788094] text-center mb-6'>Schedule a meeting with one of our billing experts by filling out the form below.</p>
          <form className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
            ...
            />
            <CustomSelect className='col-span-2 rounded-full px-6 font-urbanist border-none font_14_400 !bg-[#F0F1F5]' placeholder='Choose a Service' label='Services' options={selectOptions}/>
