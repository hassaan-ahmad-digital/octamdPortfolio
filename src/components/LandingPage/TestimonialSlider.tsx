...
const testimonials: TestimonialType[] = [
  {
    ...
    review: {
      stars: 1,
      description:
        `"The team at [Company Name] has completely transformed our medical billing process. Their expertise in denial management and claim submission has saved us time and significantly increased our revenue. We couldn't be happier!"`
    }
  },
  {
    id: 2,
    ...
    review: {
      stars: 2,
      description:
        `"Since partnering with [Company Name], our billing has been seamless. Their professionalism and attention to detail are unmatched. I highly recommend their services to any medical practice looking to optimize their revenue cycle."`
    }
  },
  {
    id: 3,
    ...
    review: {
      stars: 3,
      description:
        `"The accuracy and efficiency of [Company Name]'s medical billing services have been a game-changer for our practice. Their team is knowledgeable and always available to help with any issues. We’ve seen a 20% increase in our revenue collection!"`
    }
  },
  {
    id: 4,
    ...
    review: {
      stars: 4,
      description:
        `"Partnering with [Company Name] has streamlined our billing process beyond what we expected. Their commitment to compliance and attention to detail means we can focus on patient care without worrying about our financials."`
    }
  },
  {
    id: 5,
    ...
    review: {
      stars: 5,
      description:
        `"Our clinic has benefited immensely from [Company Name]'s customized billing solutions. They helped us reduce denied claims and improve cash flow. I highly recommend them to any medical provider."`
    }
  }
]
