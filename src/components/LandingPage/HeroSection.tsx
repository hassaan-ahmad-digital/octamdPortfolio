          ...
          <div className='innerContainer flex flex-col relative 2xl:bottom-[8rem] items-start'>
            <div className='max-w-[42rem] flex flex-col gap-10'>
              ...
              <p className='text-white'>
                We aim to provide accurate, reliable, and timely billing solutions, ensuring
                healthcare providers can focus on patient care while we handle administrative tasks.
              </p>
...
const Feature = ({ icon, title, desc }: Feature) => {
  return (
    <div className='flex items-start max-w-[300px] gap-4'>
      <Image className='relative top-2' src={icon} alt='title' height={60} width={60} />
