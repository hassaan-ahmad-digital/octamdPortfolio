...
export default function page({}: Props) {
  return (
    <>
      ...
      <h3 className='font-urbanist mt-10 font_36_700 text-titleColor'>What is a Medical Scribe?</h3>
      <p className='mt-10 font-urbanist font_16_400 text-[#788094]'>
      ...
      <p className='mt-10 font-urbanist font_16_400 text-[#788094]'>
        Our medical scribes are trained in medical terminology, coding, and healthcare workflows.
        They work alongside healthcare providers during patient visits, transcribing relevant
        details accurately into the EHR. Whether you need in-person or virtual scribe support, our
        services are tailored to meet the unique needs of your practice.
      </p>
      ...
      <ul className='flex flex-col gap-[30px] mt-8'>
        <li className='font-urbanist font_16_400 text-[#788094] flex gap-[14px]'>
          ...
          <p className='flex-1'>
            <span className='font-bold'>Highly Trained Scribes</span>&nbsp;<span>-</span>
            &nbsp;
            <span>
              Our medical scribes are well-versed in medical terminology and EHR systems, ensuring
        ...
        <li className='font-urbanist font_16_400 text-[#788094] flex gap-[14px]'>
          <FaCircleCheck className='text-themePrimary aspect-square w-5 h-5 relative top-1' />
          <p className='flex-1'>
            <span className='font-bold'>Customizable Solutions</span>&nbsp;<span>-</span>
            &nbsp;
            <span>
              Whether your practice needs in-person scribes or virtual support, we offer flexible
        ...
        <li className='font-urbanist font_16_400 text-[#788094] flex gap-[14px]'>
          <FaCircleCheck className='text-themePrimary aspect-square w-5 h-5 relative top-1' />
          <p className='flex-1'>
            <span className='font-bold'>Increased Provider Efficiency</span>&nbsp;<span>-</span>
            &nbsp;
            <span>
              By delegating documentation to our scribes, healthcare providers can see more patients
              and spend more time focusing on care, ultimately increasing efficiency and revenue.
            </span>
          </p>
        </li>
        <li className='font-urbanist font_16_400 text-[#788094] flex gap-[14px]'>
          <FaCircleCheck className='text-themePrimary aspect-square w-5 h-5 relative top-1' />
          <p className='flex-1'>
            <span className='font-bold'>Better Patient Interaction</span>&nbsp;<span>-</span>
            &nbsp;
            <span>
              With medical scribes handling the administrative tasks, healthcare providers can spend
              more time interacting with their patients, improving the overall patient experience.
            </span>
          </p>
        </li>
      </ul>
