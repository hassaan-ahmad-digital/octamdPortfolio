...
export const services: Services[] = [
  {
    ...
    color: 'blueishGray',
    content: {
      desc: 'Our team comprises certified medical billing professionals with years of experience in various specialties, ensuring accurate and timely claim submissions.',
      // points: [
